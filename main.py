...
class PredictInput(BaseModel):
    ...
    def producto_debe_existir(cls, v):
        v_upper = v.upper()
        # Mantenemos tu validación de existencia en la lista
...
def predict(data: PredictInput):
    ...
    try:
        ...
        # 4. Producto (One-Hot Encoding que ya tenías)
        ...
        # 5. Procedencia (Tu validación original)
        ...
        raise he # Re-lanzamos el error de fecha anterior para que no lo capture el except general
    except Exception as e:
